...
To explore the initial parameter manifold, we use Latin Hypercube Sampling (LHS), the stratified sampling strategy described in \cref{subsec:slam-hyperparameter}.
...
A primary challenge in SLAM optimisation is the risk of ``over-specialisation'', where parameters become overfitted to the unique noise characteristics of a single trajectory \cite{limAdaLIORobustAdaptive2023}. We implement a Consensus Survival Framework to prioritise reliability across datasets.
