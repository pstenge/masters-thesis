...
The error distributions and consensus progression plots for both tuning processes are presented in \cref{app:slam-optimisation-figures} (\cref{fig:comparison_dist,fig:comparison_progression}).
...
Full trajectory comparisons between baseline GLIM and GLIM-GNSS across all five datasets are presented in \cref{app:slam-trajectory-figures} (\cref{fig:large_grid_xy,fig:large_grid_z}).
