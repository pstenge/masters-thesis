...
A heatmap of ICP fitness across all 315 hypotheses is presented in \cref{app:pa-supplementary-figures} (\cref{fig:pa-lidar-heatmap}).
...
\Cref{fig:pa-stereo-converged-overlay} in \cref{app:pa-supplementary-figures} presents the final alignment for all seven converging conditions.
